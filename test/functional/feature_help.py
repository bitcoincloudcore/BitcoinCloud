...
"""Verify that starting bitcoincloud with -h works as expected."""

from test_framework.test_framework import BitcoinCloudTestFramework
from test_framework.util import assert_equal

class HelpTest(BitcoinCloudTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitcoincloud with -h for help text")
        ...
        self.log.info("Start bitcoincloud with -version for version information")
        ...
        self.log.info("Start bitcoincloudd with -fakearg to make sure it does not start")
