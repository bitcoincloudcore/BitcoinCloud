...
# TestP2PConn: A peer we use to send messages to bitcoincloudd, and store responses.
...
class CompactBlocksTest(BitcoinCloudTestFramework):
    ...
    # This test actually causes bitcoincloudd to (reasonably!) disconnect us, so do this last.
    ...
    # bitcoincloudd's choice of nonce.
    ...
    # Test that bitcoincloudd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for bitcoincloudd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # bitcoincloudd will not send blocktxn responses for blocks whose height is
