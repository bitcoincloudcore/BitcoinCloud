...
#ifndef BITCOINCLOUD_INTERFACES_NODE_H
#define BITCOINCLOUD_INTERFACES_NODE_H
...
//! Top-level interface for a bitcoincloud node (bitcoincloudd process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // BITCOINCLOUD_INTERFACES_NODE_H
