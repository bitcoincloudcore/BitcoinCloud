...
std::map<CTxDestination, std::vector<COutput>> CWallet::ListCoins() const
{
    ...
    // https://github.com/bitcoincloud/bitcoincloud/pull/10340, but that change has been
    // postponed until after https://github.com/bitcoincloud/bitcoincloud/pull/10244 to
...
bool CWallet::CreateTransaction(const std::vector<CRecipient>& vecSend, CTransactionRef& tx, CReserveKey& reservekey, CAmount& nFeeRet, int& nChangePosInOut, std::string& strFailReason, const CCoinControl& coin_control, bool sign)
{
    ...
    int nBytes;
    {
        ...
        LOCK2(cs_main, cs_wallet);
        {
            ...
            // change transaction isn't always pay-to-bitcoincloud-address
 ...
 * https://bitcoincloudtalk.org/?topic=54527, or
 * https://github.com/bitcoincloud/bitcoincloud/pull/1393.
 */
