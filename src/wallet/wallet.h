...
#ifndef BITCOINCLOUD_WALLET_WALLET_H
#define BITCOINCLOUD_WALLET_WALLET_H
...
public:
     ...
     * on this bitcoincloud node, and set to 0 for transactions that were created
...
#endif // BITCOINCLOUD_WALLET_WALLET_H
