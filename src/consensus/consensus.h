...
#ifndef BITCOINCLOUD_CONSENSUS_CONSENSUS_H
#define BITCOINCLOUD_CONSENSUS_CONSENSUS_H
...
// version. The former uses BitcoinCloud parameters, but if this fork is a fork
...
#endif // BITCOINCLOUD_CONSENSUS_CONSENSUS_H
