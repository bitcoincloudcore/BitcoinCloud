...
#if defined(NDEBUG)
#error "BitcoinCloud cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "BitcoinCloud Signed Message:\n";
...
{
    RenameThread("bitcoincloud-scriptch");
