...
{
    BOOST_CHECK(TestSplitHost("www.bitcoincloudcore.org", "www.bitcoincloudcore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.bitcoincloudcore.org]", "www.bitcoincloudcore.org", -1));
    BOOST_CHECK(TestSplitHost("www.bitcoincloudcore.org:80", "www.bitcoincloudcore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.bitcoincloudcore.org]:80", "www.bitcoincloudcore.org", 80));
