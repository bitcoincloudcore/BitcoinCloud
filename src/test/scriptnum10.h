...
#ifndef BITCOINCLOUD_TEST_SCRIPTNUM10_H
#define BITCOINCLOUD_TEST_SCRIPTNUM10_H
...
{
    /**
 * The ScriptNum implementation from BitcoinCloud Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // BITCOINCLOUD_TEST_BIGNUM_H
