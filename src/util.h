 ...
 */
#ifndef BITCOINCLOUD_UTIL_H
#define BITCOINCLOUD_UTIL_H
...
extern const char* const BITCOINCLOUD_CONF_FILENAME;
extern const char* const BITCOINCLOUD_PID_FILENAME;
...
{
    std::string s = strprintf("bitcoincloud-%s", name);
