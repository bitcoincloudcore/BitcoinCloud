                                                                   ...
                                                                   mapper(0)
{
    ...
    ui->bitcoincloudAtStartup->setToolTip(ui->bitcoincloudAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->bitcoincloudAtStartup->setText(ui->bitcoincloudAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openBitcoinCloudConfButton->setToolTip(ui->openBitcoinCloudConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new BitcoinCloudUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->bitcoincloudAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openBitcoinCloudConfButton_clicked()
{
    ...
    if (!GUIUtil::openBitcoinCloudConf())
