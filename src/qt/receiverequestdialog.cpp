...
#include <config/bitcoincloud-config.h> /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatBitcoinCloudURI(info);
    ...
    if (info.amount)
        html += "<b>" + tr("Amount") + "</b>: " + BitcoinCloudUnits::formatHtmlWithUnit(model->getOptionsModel()->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatBitcoinCloudURI(info));
}
