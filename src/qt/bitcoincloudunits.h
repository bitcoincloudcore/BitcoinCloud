...
#ifndef BITCOINCLOUD_QT_BITCOINCLOUDUNITS_H
#define BITCOINCLOUD_QT_BITCOINCLOUDUNITS_H
...
/** BitcoinCloud unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BitcoinCloudUnits : public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BitcoinCloudUnits(QObject* parent);

    /** BitcoinCloud units.
      @note Source: https://en.bitcoincloud.it/wiki/Units . Please add only sensible ones
     */
    enum Unit {
        BCL,
        mBCL,
...
typedef BitcoinCloudUnits::Unit BitcoinCloudUnit;

#endif // BITCOINCLOUD_QT_BITCOINCLOUDUNITS_H
