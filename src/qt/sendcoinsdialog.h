...
#ifndef BITCOINCLOUD_QT_SENDCOINSDIALOG_H
#define BITCOINCLOUD_QT_SENDCOINSDIALOG_H
...
/** Dialog for sending bitcoinclouds */
...
#endif // BITCOINCLOUD_QT_SENDCOINSDIALOG_H
