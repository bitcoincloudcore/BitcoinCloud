...
static void SetupBitcoinCloudTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " bitcoincloud-tx utility version " + FormatFullVersion() + "\n\n" +
                               "Usage:  bitcoincloud-tx [options] <hex-tx> [commands]  Update hex-encoded bitcoincloud transaction\n" +
                               "or:     bitcoincloud-tx [options] -create [commands]   Create hex-encoded bitcoincloud transaction\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bitcoincloud transaction
