BitcoinCloud Core version 0.14.1 is now available from:

  <https://bitcoincloud.org/bin/bitcoincloud-core-0.14.1/>
...
here:
[reducing-bitcoincloudd-memory-usage.md](https://gist.github.com/laanwj/efe29c7661ce9b6620a7).
...
- #10130 `ecc5232` bitcoincloud-tx input verification (awemany, jnewbery)
