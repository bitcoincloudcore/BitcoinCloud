BitcoinCloud-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bitcoincloud/files/BitcoinCloud/bitcoincloud-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the BitcoinCloud
...
New/changed settings (command-line or bitcoincloud.conf file)
--------------------------------------------------------
