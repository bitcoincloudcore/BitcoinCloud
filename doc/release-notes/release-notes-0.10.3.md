BitcoinCloud Core version 0.10.3 is now available from:

  <https://bitcoincloud.org/bin/bitcoincloud-core-0.10.3/>
...
(see https://github.com/bitcoincloud/bitcoincloud/pull/6793, as well as the 0.11.0
