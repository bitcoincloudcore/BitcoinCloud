BitcoinCloud Core version 0.14.2 is now available from:

  <https://bitcoincloud.org/bin/bitcoincloud-core-0.14.2/>
...
(in BitcoinCloud Core 0.10.3) it has been disabled by default.
...
Since 0.14.0 the approximate transaction fee shown in BitcoinCloud-Qt when using coin
...
- #10228 `ae479bc` Regenerate bitcoincloud-config.h as necessary (theuni)
