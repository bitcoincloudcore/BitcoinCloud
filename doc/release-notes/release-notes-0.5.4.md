BitcoinCloud version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitcoincloud/files/BitcoinCloud/bitcoincloud-0.5.4/
...
http://gitorious.org/bitcoincloud/bitcoincloudd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix BitcoinCloud-Qt notifications under Growl 1.3.
Increase required age of BitcoinCloud-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitcoinCloud properly when installing BitcoinCloud-Qt over it. (Windows)
