BitcoinCloud Core version 0.10.4 is now available from:

  <https://bitcoincloud.org/bin/bitcoincloud-core-0.10.4/>
...
- #6953 `43c2789` Split bitcoincloud-tx into its own package
- #6953 `dfe0d4d` Include bitcoincloud-tx binary on Debian/Ubuntu
