BitcoinCloud Core version 0.13.2 is now available from:

  <https://bitcoincloud.org/bin/bitcoincloud-core-0.13.2/>
...
- #8908 `4a974b2` Update bitcoincloud-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow bitcoincloud-tx to create v2 transactions (btcdrak)
