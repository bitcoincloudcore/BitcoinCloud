Download URL: https://sourceforge.net/projects/bitcoincloud/files/BitcoinCloud/bitcoincloud-0.3.22/
...
* IRC is overflowing.  Client now bootstraps to channels #bitcoincloud00 - #bitcoincloud99
