BitcoinCloud Core version 0.16.1 is now available from:

  <https://bitcoincloudcore.org/bin/bitcoincloud-core-0.16.1/>
...
- #12843 `df38b13` Test starting bitcoincloudd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure bitcoincloudd processes are cleaned up when tests end (sdaftuar)
