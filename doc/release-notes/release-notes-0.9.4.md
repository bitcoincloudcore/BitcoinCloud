BitcoinCloud Core version 0.9.4 is now available from:

  https://bitcoincloud.org/bin/0.9.4/
...
this update is incompatible with the BitcoinCloud system and could lead to consensus
forks.

BitcoinCloud Core released binaries from https://bitcoincloud.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitcoincloud/+archive/ubuntu/bitcoincloud
- A third-party or self-compiled BitcoinCloud Core

upgrade to BitcoinCloud Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
