BitcoinCloud Core version *0.15.0.1* is now available from:

  <https://bitcoincloud.org/bin/bitcoincloud-core-0.15.0.1/>

and

  <https://bitcoincloudcore.org/bin/bitcoincloud-core-0.15.0.1/>
