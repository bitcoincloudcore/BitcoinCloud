...
* bitcoincloud.conf: contains configuration settings for bitcoincloudd or bitcoincloud-qt
* bitcoincloudd.pid: stores the process id of bitcoincloudd while running
...
* debug.log: contains debug information and general logging generated by bitcoincloudd or bitcoincloud-qt
