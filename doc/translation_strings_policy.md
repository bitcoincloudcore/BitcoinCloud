...
This document provides guidelines for internationalization of the BitcoinCloud Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bitcoincloud_en.ts` remains unchanged.
